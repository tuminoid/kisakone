 ...
 *
 * Tournament overall score calculation: 2 worst events ignored
 *
 * NOTE: Event scoring should be completely rewritten, this is just
 * copied from the ignoreworst calculation and just 2 worst removed
 *
 * --
 *
 ...
 * */
class scorecalc_tournament_ignore2worst
{
    var $name;
    var $id;
    var $numEvents;

    function scorecalc_tournament_ignore2worst()
    {
        $this->id = substr(get_class($this), 21);
        $this->name = translate('tournament_scores_ignore2worst');
    }
